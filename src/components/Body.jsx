      ...
      {selectedPlaylist && (
        <>
          <div className="playlist">
            <div className="image">
              <img src={selectedPlaylist.img} alt="selected Playlist" />
            </div>
          ...
          <div className="list">
            ...
            <div className="tracks">
              {selectedPlaylist.tracks && selectedPlaylist.tracks.map(({
                id,
                name,
                artists,
                img,
                ...
                return (
                  <div className="row" key={id}>
                    ...
                    <div className="col">
                      <span>{msTominutsAndSeconds(duration)}</span> 
                    </div>
                  </div>
                );
              })}
